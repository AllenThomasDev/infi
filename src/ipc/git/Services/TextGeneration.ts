...
// Minimal stand-in for t3code's ChatAttachment (from orchestration contracts).
// Only used by BranchNameGenerationInput which our stub layer ignores.
interface ChatAttachment { readonly type: string; readonly id: string }

import type { TextGenerationError } from "../Errors";
